      ...
      <?php  
        ...
        ?>
          <form method="post" enctype="multipart/form-data">  
                     ...
                     <input type="submit" name="insert" value="Update" class="btn btn-info" /><br><br>
          </form> 
       ...
       ?>
            <form method="POST">          
           <textarea  name="email" value="<?php echo $result1['email'];?>" class="form-control"  rows="2" cols="10" placeholder="enter your email here"></textarea><br>
